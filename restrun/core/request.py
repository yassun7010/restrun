...
class RequestMockClient(RequestClient):
    def __init__(self) -> None:
        self._store: list[
            tuple[tuple[Method, URL], ResponseModelBody | RestrunError]
        ] = []

    def inject_get_response_body(
        self,
        url: URL,
        response_body: ResponseModelBody | RestrunError,
    ):
    ...
    def get(
        ...
        *,
        ...
        return self._extract_response_body("GET", url)
    ...
    def post(
        ...
        *,
        ...
        return self._extract_response_body("POST", url)
    ...
    def put(
        ...
        *,
        ...
        return self._extract_response_body("PUT", url)
    ...
    def patch(
        ...
        *,
        ...
        return self._extract_response_body("PATCH", url)
    ...
    def delete(
        ...
        *,
        ...
        return self._extract_response_body("DELETE", url)
