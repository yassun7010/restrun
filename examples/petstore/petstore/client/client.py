...
from .mixins import (
    ...
    bearer_token_login_mixin2,
)



class PetstoreClient(bearer_token_login_mixin.bearerTokenLoginMixin, bearer_token_login_mixin2.bearerTokenLoginMixin, RestrunClient):
    """
    Code generated by restrun "0.1.0".
    """
